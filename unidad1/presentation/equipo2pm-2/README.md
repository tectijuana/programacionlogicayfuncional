...
|:-:|:--|:--|
| 1 | GALLEGOS HERNANDEZ, LEONARDO | Contexto e historia |
| 2 | ORENDAIN CAMACHO, DIEGO ALEJANDRO | Modelo de cómputo y sintaxis |
| 3 | PECH GONZALEZ, LUIS ARIEL | Sistema de tipos / runtime |
| 4 | PEREZ LOPEZ, CARLOS IVAN | Demo en vivo + caso real |
...
5. **Caso real + cierre (2 min)** — Apache Spark con referencia IEEE; conexión con Haskell y Clojure (JVM).
