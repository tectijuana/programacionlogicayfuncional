...
|:-:|:--|:--|
| 1 | VALDEZ AMPARO, ANDRES CARLOS | Contexto e historia |
| 2 | VALDEZ AMPARO, RICARDO DAVID | Modelo de cómputo y sintaxis |
| 3 | VILLALOBOS LEON, CESAR ALEJANDRO | Sistema de tipos / runtime |
| 4 | VILLANUEVA BARAJAS, JOSUE | Demo en vivo + caso real |
...
5. **Caso real + cierre (2 min)** — Nubank con referencia IEEE; conexión con Haskell y Scala (JVM) y con la Tarea 1.3 (inmutabilidad).
